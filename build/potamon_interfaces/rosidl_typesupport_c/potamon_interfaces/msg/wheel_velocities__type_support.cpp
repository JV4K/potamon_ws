...
static const _WheelVelocities_type_support_symbol_names_t _WheelVelocities_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, potamon_interfaces, msg, WheelVelocities)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, potamon_interfaces, msg, WheelVelocities)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, potamon_interfaces, msg, WheelVelocities)() {
  return &::potamon_interfaces::msg::rosidl_typesupport_c::WheelVelocities_message_type_support_handle;
}
