...
#include "potamon_interfaces/msg/detail/wheel_states__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const potamon_interfaces::msg::WheelStates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  potamon_interfaces::msg::WheelStates & ros_message)
{
  // Member: angle
  {
    cdr >> ros_message.angle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = potamon_interfaces::msg::WheelStates;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_potamon_interfaces
max_serialized_size_key_WheelStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const potamon_interfaces::msg::WheelStates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<potamon_interfaces::msg::WheelStates *>(
    untyped_ros_message);
...
{
  return &potamon_interfaces::msg::typesupport_fastrtps_cpp::_WheelStates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, potamon_interfaces, msg, WheelStates)() {
  return &potamon_interfaces::msg::typesupport_fastrtps_cpp::_WheelStates__handle;
}
