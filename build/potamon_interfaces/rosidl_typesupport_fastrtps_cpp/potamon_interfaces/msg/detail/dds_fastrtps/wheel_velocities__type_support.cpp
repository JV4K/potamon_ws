...
#include "potamon_interfaces/msg/detail/wheel_velocities__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = potamon_interfaces::msg::WheelVelocities;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const potamon_interfaces::msg::WheelVelocities *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<potamon_interfaces::msg::WheelVelocities *>(
    untyped_ros_message);
...
{
  return &potamon_interfaces::msg::typesupport_fastrtps_cpp::_WheelVelocities__handle;
}
