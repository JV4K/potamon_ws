...
static const _WheelVelocities_type_support_symbol_names_t _WheelVelocities_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, potamon_interfaces, msg, WheelVelocities)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, potamon_interfaces, msg, WheelVelocities)),
  }
};
...
{
  return &::potamon_interfaces::msg::rosidl_typesupport_cpp::WheelVelocities_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, potamon_interfaces, msg, WheelVelocities)() {
  return get_message_type_support_handle<potamon_interfaces::msg::WheelVelocities>();
}
