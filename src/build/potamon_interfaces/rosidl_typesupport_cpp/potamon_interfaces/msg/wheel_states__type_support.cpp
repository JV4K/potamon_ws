...
static const _WheelStates_type_support_symbol_names_t _WheelStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, potamon_interfaces, msg, WheelStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, potamon_interfaces, msg, WheelStates)),
  }
};
...
{
  return &::potamon_interfaces::msg::rosidl_typesupport_cpp::WheelStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, potamon_interfaces, msg, WheelStates)() {
  return get_message_type_support_handle<potamon_interfaces::msg::WheelStates>();
}
